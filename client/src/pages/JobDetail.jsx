...
import { AiOutlineSafetyCertificate, AiOutlineStar } from 'react-icons/ai';
      ...
      <div className="w-full flex flex-col md:flex-row gap-10">
        ...
        <div className="w-full h-fit md:w-2/3 2xl:2/4 bg-white px-5 py-10 md:px-10 shadow-md">
          ...
          <div className="w-full flex flex-wrap md:flex-row gap-2 items-center justify-between my-10">
            ...
            <div className="bg-[#bae5f4] w-40  rounded-lg flex flex-col items-center justify-center">
            ...
            {selected === '0' ? (
              ...
              <>
                <div className="mb-6 flex flex-col">
                  ...
                  <span className="text-sm">{job?.company?.travel}</span>
                </div>

                <p className="text-xl font-semibold">About Teacher</p>
          ...
          <div className="w-full">
            <CustomButton
              title="Apply Now"
              containerStyles={`w-full flex items-center justify-center text-white bg-black hover:bg-blue-700 py-3 px-5 outline-none rounded-full text-base`}
            />
          </div>
        </div>
